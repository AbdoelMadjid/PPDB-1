<?php  
	...
	if (isset($_SESSION['is_data_student_exist'])) {
		...
		$redirect = "<script> window.location='daftar_data_alamat.php'; </script>";
	}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group label-floating">
										...
										value="<?php isset($_SESSION['religion'])  ?  print($_SESSION['religion']) : ""; ?>"
                                        required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" class="form-control" name="future_goals" 
										value="<?php isset($_SESSION['future_goals'])  ?  print($_SESSION['future_goals']) : ""; ?>"
                                        required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group label-floating">
										...
										value="<?php isset($_SESSION['hobby'])  ?  print($_SESSION['hobby']) : ""; ?>"
                                        required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            	<div class="col-md-4">
                                    <div class="form-group label-floating">
										...
										value="<?php isset($_SESSION['weight'])  ?  print($_SESSION['weight']) : ""; ?>" 
                                        required>
                                    </div>
                                </div>
                              	...
                              	<div class="col-md-4">
                              		<div class="form-group label-floating">
										...
										value="<?php isset($_SESSION['height'])  ?  print($_SESSION['height']) : ""; ?>"
                                        required>
                                    </div>
                              	</div>	
                                ...
                                <div class="col-md-4">
                                    <div class="form-group label-floating">
										...
										value="<?php isset($_SESSION['blood_type'])  ?  print($_SESSION['blood_type']) : ""; ?>"
                                        required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group label-floating">
										...
										value="<?php isset($_SESSION['disease'])  ?  print($_SESSION['disease']) : ""; ?>"
                                        required>
                                    </div>
                                </div>
                            </div>

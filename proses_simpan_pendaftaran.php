<?php
	...
	if (isset($_SESSION)) {
		...
		$sql	= "INSERT INTO pendaftaran VALUES(null,'$full_name', '$nick_name', '$birth_place'
					, '$birth_date' ,'$gender', '$child_number', '$child_total', '$religion', '$future_goals', '$hobby', '$weight', '$height', '$blood_type', '$disease'
					, '$home_address' ,'$rt', '$rw', '$vilage_office', '$district', '$city', '$province', '$postal_code', '$house_phone', '$live_with'
					...
					, '$mother_last_education', '$mother_job','$mother_religion', '$telp', '$pai', '$indo', '$english', '$mate'
					, '$ipa', '$ips', '$goals', '$info','','','','')";

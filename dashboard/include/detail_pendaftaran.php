...
<table class="table table-hover">
    ...
    <tbody>
        ...
        <tr>
            <td><b>Agama</b></td>
            <td>: <?php echo $daftar['agama']; ?></td>
        </tr>
        <tr>
            <td><b>Cita-cita</b></td>
            <td>: <?php echo $daftar['cita_cita']; ?></td>
        </tr>
        <tr>
            <td><b>Hobby</b></td>
            <td>: <?php echo $daftar['hobby']; ?></td>
        </tr>
        <tr>
            <td><b>Berat Badan</b></td>
            <td>: <?php echo $daftar['berat_badan']; ?></td>
        </tr>
        <tr>
            <td><b>Tinggi Badan</b></td>
            <td>: <?php echo $daftar['tinggi_badan']; ?></td>
        </tr>
        <tr>
...
<ol>
	...
	<li>Kartu Keluarga <a href="<?php echo '../assets/uploads/'.$daftar['upload_kartu_keluarga'];  ?>" title="Download Kartu Keluarga><i class="fa fa-download"></i></a></li>
	<li>Foto Anak <a href="<?php echo '../assets/uploads/'.$daftar['foto_anak'];  ?>" title="Download Foto Siswa"><i class="fa fa-download"></i></a></li>
</ol>

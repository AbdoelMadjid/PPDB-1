                    ...
                    <li>
                        <?php 
                            ...
                            if ($foto_anak != "") {
                                ...
                                if ($daftar['status_pendaftaran'] == 1) {
                                    echo '<font color="#2ecc71">Foto siswa berwarna berkemeja ukuran 3x4<i class="fa fa-check"></i></font>';
                                }else if($daftar['status_pendaftaran'] >= 2){
                                    echo '<font color="#2ecc71">Foto siswa berwarna berkemeja ukuran 3x4<i class="fa fa-check"></i></font>';
                                }else{
                                    echo '<font color="#2ecc71">Foto siswa berwarna berkemeja ukuran 3x4<i class="fa fa-check"></i></font> <a href="index.php?page=6" class="btn btn-primary btn-sm" title="Upload Akte Kelahiran dan Kartu Keluarga"><i class="fa fa-pencil"></i></a>';
                                }
                                
                            }else{
                                echo 'Foto siswa berwarna berkemeja ukuran 3x4 <a href="index.php?page=6" class="btn btn-primary btn-sm" title="Upload Akte Kelahiran dan Kartu Keluarga"><i class="fa fa-upload"></i></a>';
                            }
